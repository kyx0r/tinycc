...
-UCONFIG_TCCBOOT \
-UDEBUG_VERSION \
__all.c > tcc_linux_x86_64.c

astyle -xb -n -H --style=linux --max-code-length=80 --indent=force-tab=8 --squeeze-ws --squeeze-lines=1 --align-pointer=name tcc_linux_x86_64.c
